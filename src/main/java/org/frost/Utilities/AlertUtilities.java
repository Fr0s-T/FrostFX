...
public final class AlertUtilities {
     ...
     */
    private  boolean showConfirmationInternal(String title, String message, Image icon) {
     ...
     * @param icon    the icon to apply, or {@code null}
     */
    private  void showAlert(Alert.AlertType type, String title, String message, Image icon) {
        Runnable dialog = () -> {
